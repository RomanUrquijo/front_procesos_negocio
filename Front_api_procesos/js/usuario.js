...
const urlApi = "http://localhost:9050";//colocar la url con el puerto
    ...
    fetch(urlApi + "/usuario/" + id, settings)
        ...
        <div class="row">
            ...
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control" name="nombre" id="nombre" required value="${usuario.nombre}" onkeypress="return sololetras(event);" >
            </div>

            <div class="form-group col-6">
                <label for="apellidos" class="form-label">Apellido</label>
                <input type="text" class="form-control" name="apellidos" id="apellidos" required value="${usuario.apellidos}" onkeypress="return sololetras(event);" >
            </div>

            <div class="form-group col-6">
                <label for="documento" class="form-label">Documento</label>
                <input type="text" class="form-control" name="documento" id="documento" required value="${usuario.documento}" onkeypress="return solonumeros(event);" maxlength="15">
            </div>

            <div class="form-group col-6">
                <label for="direccion" class="form-label">direccion</label>
                <input type="text" class="form-control" name="direccion" id="direccion" required value="${usuario.direccion}">
            </div>

            <div class="form-group col-6">
                <label for="correo" class="form-label">Fecha</label>
                <input type="date" class="form-control" name="fechaNacimiento" id="fechaNacimiento" required value="${usuario.fechaNacimiento}">
            </div>

            <div class="form-group col-6">
                <label for="telefono" class="form-label">telefono</label>
                <input type="number" class="form-control" name="telefono" id="telefono" required value="${usuario.telefono}" onkeypress="return solonumeros(event);" maxlength="12">
            </div>

            <div class="form-group col-6">
                <label for="correo" class="form-label">correo</label>
                <input type="email" class="form-control" name="correo" id="correo" required value="${usuario.correo}">
            </div>

            <div class="form-group col-6">
            <label for="correo" class="form-label">Password</label>
                <input type="password" class="form-control" id="password" name="password" value="${usuario.password}" required> <br>
            </div>
...
function verUsuario(id) {
    ...
    fetch(urlApi + "/usuario/" + id, settings)
        ...
        <div class="row">
            ...
            <div class="form-group col-6">
                <label for="apellidos" class="form-label">Apellido</label>
                <input type="text" class="form-control" name="apellidos" id="apellidos" required value="${usuario.apellidos}">
            </div>

            <div class="form-group col-6">
                <label for="documento" class="form-label">Documento</label>
                <input type="text" class="form-control" name="documento" id="documento" required value="${usuario.documento}">
            </div>

            <div class="form-group col-6">
                <label for="correo" class="form-label">Fecha</label>
                <input type="text" class="form-control" name="fechaNacimiento" id="fechaNacimiento" required value="${usuario.fechaNacimiento}">
            </div>
            ...
            <div class="form-group col-6">
                <label for="telefono" class="form-label">telefono</label>
                <input type="number" class="form-control" name="telefono" id="telefono" required value="${usuario.telefono}">
            </div>

            <div class="form-group col-6">
                <label for="correo" class="form-label">correo</label>
                <input type="correo" class="form-control" name="correo" id="correo" required value="${usuario.correo}">
            </div>
        </div>
                `;
...
function registerForm(auth = false) {
    cadena = `
            ...
            <form action="" method="post" id="myFormReg">
                ...
                <input type="text" class="form-control" name="apellidos" id="apellidos" onkeypress="return sololetras(event);" required> <br>

                <label for="documento"  class="form-label">document</label>
                <input type="text" class="form-control" name="documento" id="documento" onkeypress="return solonumeros(event);" maxlength="15" required> <br>
                ...
                <input type="date" class="form-control" name="fechaNacimiento" id="fechaNacimiento" required> <br>

                <label for="telefono" class="form-label">Telefono</label>
                <input type="text" class="form-control" name="telefono" id="telefono" onkeypress="return solonumeros(event);" maxlength="12" required> <br>
